...
@section('content')
    <div class="container-fluid  mt-4">
        <div class="card">
            ...
            <div class="card-body">
                <form method="post" action="{{route('admin.collection.update',[$collection->id])}}" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <img style="max-height: 300px;" id="imp-preview-icon" src="{{ url("storage/collection/{$collection->icon}") }}" class="img-thumbnail"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mt-2">
                                                    <img style="max-height: 300px;" id="imp-preview-image" src="{{ url("storage/collection/{$collection->image}") }}" class="img-thumbnail"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            <input name="summary" id="input-name" class="form-control{{ $errors->has('summary') ? ' is-invalid' : '' }}" value="{{old('summary', $collection->summary)}}"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label for="example-text-input" class="col-md-4 col-form-label form-control-label text-right">
                                                    {{ __('collection.field.priority.label') }}
                                                </label>
                                                <div class="col-md-8">
                                                    <input type="number" name="priority" id="input-name" class="form-control{{ $errors->has('priority') ? ' is-invalid' : '' }}" placeholder="0" maxlength="2" value="{{old('priority',$collection->priority)}}">
                                            ...
                                            <div class="col-md-2">
                                                @foreach($categories as $category)
                                                    <div class="custom-control custom-checkbox">
                                                        <input class="custom-control-input" name="category_id[]" id="jc-{{$category['id']}}" type="checkbox" value="{{$category['id']}}" @if (in_array($category['id'], $selected)) checked @endif >
